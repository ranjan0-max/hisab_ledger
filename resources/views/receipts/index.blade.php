                    ...
                    <tbody>
                        @forelse($receipts as $receipt)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('receipts.show', $receipt) }}" data-modal-url="{{ route('receipts.show', ['receipt' => $receipt, 'modal' => 1]) }}" class="btn btn-sm btn-outline-secondary receipt-icon-action receipt-modal-trigger" title="View receipt" aria-label="View receipt"><i class="bi bi-eye"></i></a>
                                    @if(auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('receipts.manage'))
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between gap-3">
                        ...
                        <div class="receipt-mobile-top-actions">
                            <a href="{{ route('receipts.show', $receipt) }}" data-modal-url="{{ route('receipts.show', ['receipt' => $receipt, 'modal' => 1]) }}" class="btn receipt-icon-action receipt-view-action receipt-modal-trigger" title="View receipt" aria-label="View receipt"><i class="bi bi-eye"></i></a>
                            @if(auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('receipts.manage'))
