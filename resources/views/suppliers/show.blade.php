                    ...
                    <tbody>
                        @forelse($transactions as $tx)
                            <tr class="{{ $tx->status === 'VOID' ? 'table-secondary text-decoration-line-through' : '' }}">
                                ...
                                <td class="text-end fw-bold text-info">₹{{ number_format($tx->running_balance, 2) }}</td>
                                <td class="text-end">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        ...
                        <div class="text-end">
                            ...
                            <div class="small text-info fw-semibold">Bal: ₹{{ number_format($tx->running_balance, 2) }}</div>
                        </div>
                    </div>
