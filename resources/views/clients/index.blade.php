                ...
                <div class="card-body">
                    ...
                    @if(auth()->user()->isSuperAdmin())
                        ...
                        <div class="small mb-3 p-2 rounded bg-light border">
                            ...
                            {{ $client->next_renewal_date?->format('d M Y') ?? 'Not configured' }}
                        </div>
                    @endif
                    
                    @if(auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('clients.manage'))
                        <div class="border-top pt-2 d-flex gap-2 justify-content-end">
        ...
        <div class="modal-content">
            <form method="POST" action="{{ route('clients.store') }}">
                ...
                <div class="modal-body">
                    ...
                    @if(auth()->user()->isSuperAdmin())
                    <div class="mt-3 p-3 rounded border border-primary-subtle bg-primary-subtle">
